...
COMMUNITY_LIST_SOURCES="${COMMUNITY_LIST_SOURCES:-https://api.github.com/repos/bitsocialnet/lists/contents/5chan-directories?ref=master}"
...
Environment=COMMUNITY_LIST_SOURCES=${COMMUNITY_LIST_SOURCES}
Environment=MAX_COMMUNITIES=${MAX_COMMUNITIES}
